...
function PaymentScreen({plan,kullanici,onSuccess,onBack}){const[copied,setCopied]=require("react").useState("");return(<div style={{minHeight:"100vh",background:"#0a0a0f",color:"#e8e8f0",fontFamily:"sans-serif",padding:"28px 16px"}}><button onClick={onBack} style={{background:"none",border:"none",color:"#888",fontSize:14,cursor:"pointer",marginBottom:20}}>← Geri dön</button><div style={{background:"#6c63ff12",border:"1px solid #6c63ff30",borderRadius:16,padding:16,marginBottom:16}}><div style={{fontSize:14,fontWeight:800,marginBottom:12}}>💜 Papara ile Öde</div><div style={{fontSize:13,color:"#fff",marginBottom:8}}>Papara No: 2131101150</div><div style={{fontSize:13,color:"#fff"}}>Ad: Uğurcan Pınarbaş</div></div><div style={{background:"#00d4aa12",border:"1px solid #00d4aa30",borderRadius:16,padding:16,marginBottom:16}}><div style={{fontSize:14,fontWeight:800,marginBottom:12}}>🏦 IBAN ile Öde</div><div style={{fontSize:13,color:"#fff",marginBottom:8}}>TR68 0082 9000 0949 2131 1011 50</div><div style={{fontSize:13,color:"#fff"}}>Ad: Uğurcan Pınarbaş</div></div><a href="https://wa.me/905360344080" target="_blank" rel="noopener noreferrer"><div style={{background:"#25D366",borderRadius:12,padding:"12px 0",textAlign:"center",fontWeight:800,color:"#fff",fontSize:14,marginTop:12,cursor:"pointer"}}>💬 WhatsApp ile Bildir</div></a><button onClick={onSuccess} style={{width:"100%",background:"#ffffff10",border:"1px solid #ffffff20",borderRadius:14,padding:"14px 0",color:"#888",fontWeight:700,fontSize:14,cursor:"pointer",marginTop:16}}>Ödemeyi Yaptım →</button></div>);}
